const InfoCard = ({ detail }) => {
  return (
    <div className="w-full flex-grow relative md:w-[32.8%] h-[158px] rounded-lg dark:text-gray-200 text-gray-700 bg-gray-100 dark:bg-secondary border border-gray-300 dark:border-primary  p-4">
      <h3 className="text-[1.03rem] font-bold dark:font-extrabold mb-3 flex items-center gap-3">
        {detail.title}
      </h3>
