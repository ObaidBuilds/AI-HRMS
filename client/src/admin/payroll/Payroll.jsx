...
function Payroll() {
  ...
  return (
    <>
      ...
      <section className="bg-gray-100 dark:bg-secondary max-h-auto min-h-screen p-3 sm:w-[95%] sm:p-4 rounded-lg shadow">
        ...
        <div id="overflow" className="overflow-auto border  min-h-[83vh]">
